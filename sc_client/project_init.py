...
from sc_client import Game, Move
...
def init_project(directory, logic, setup, calculate_move, no_git):
    logic_file_content = logic_template.replace('SETUP', setup).replace('CALCULATE_MOVE', calculate_move)
